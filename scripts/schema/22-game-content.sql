-- WURM-TOOLS MySQL Schema - Part 22: Game Content (Pages, Infoboxes, Wiki Data)
-- Run: mysql -u root -p wurmtools < 22-game-content.sql
-- Depends on: 01-core.sql
--
-- This contains the scraped/imported game content data:
-- - Pages (articles, guides, item descriptions)
-- - Infoboxes (structured item/recipe data)
-- - Categories, sections, links, images

-- ========== PAGES ==========
-- Main content pages (items, guides, etc.)
...
CREATE TABLE IF NOT EXISTS pages (
  ...
  INDEX idx_pages_article_id (article_id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ========== CATEGORIES ==========
-- Content categories for filtering/organization
...
-- ========== INFOBOXES ==========
-- Structured data boxes (item stats, recipe info, etc.)
...
-- ========== INFOBOX FIELDS ==========
-- Individual fields within infoboxes (Materials, Tools, Skill, etc.)
...
-- ========== PAGE SECTIONS ==========
-- Content sections within pages (headings + content)
...
CREATE TABLE IF NOT EXISTS page_sections (
  ...
  INDEX idx_sections_page_order (page_id, section_order),
  CONSTRAINT fk_ps_page FOREIGN KEY (page_id) REFERENCES pages(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ========== PAGE LINKS ==========
-- Internal/external links found in pages
...
CREATE TABLE IF NOT EXISTS page_links (
  ...
  INDEX idx_links_page (page_id),
  INDEX idx_links_to_slug (to_slug),
  CONSTRAINT fk_pl_page FOREIGN KEY (page_id) REFERENCES pages(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- ========== IMAGES ==========
-- Image registry (deduplicated)
...
CREATE TABLE IF NOT EXISTS content_import_logs (
  ...
  CONSTRAINT fk_content_import_user FOREIGN KEY (imported_by) REFERENCES users(id) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
