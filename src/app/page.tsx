...
export default function Home() {
  ...
  const featureShowcases = [
    {
      ...
      imageSrc: "/img/screenshot/crafting.jpg",
      imageAlt: "Crafting calculator screenshot",
    },
    {
      id: "cooking",
      ...
      imageSrc: "/img/screenshot/cook.jpg",
      imageAlt: "Crafting calculator screenshot",
    },
    {
      id: "animals",
      ...
      imageSrc: "/img/screenshot/animals.jpg",
      imageAlt: "Crafting calculator screenshot",
    },
    {
      id: "market",
      ...
      imageSrc: "/img/screenshot/market.jpg",
      imageAlt: "Crafting calculator screenshot",
    },
    {
      id: "skills",
      ...
      imageSrc: "/img/screenshot/skills.jpg",
      imageAlt: "Crafting calculator screenshot",
    },
    {
      id: "map",
      ...
      imageSrc: "/img/screenshot/map.jpg",
      imageAlt: "Crafting calculator screenshot",
    },
    {
      id: "timers",
      ...
      imageSrc: "/img/screenshot/timers.jpg",
      imageAlt: "Crafting calculator screenshot",
    },
    {
      id: "analytics",
      ...
      imageSrc: "/img/screenshot/analytics.jpg",
      imageAlt: "Crafting calculator screenshot",
    },
  ];
  ...
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative min-h-[calc(100vh-72px)] px-4 overflow-hidden flex items-center">
        {/* Animated background gradient */}
        <div className="hero-gradient" />

        {/* Floating orbs */}
        <div className="floating-orb w-96 h-96 bg-accent/20 -top-48 -left-48" />
        <div className="floating-orb w-64 h-64 bg-orange-500/15 top-20 -right-32" />
        <div className="floating-orb w-48 h-48 bg-purple-500/10 bottom-0 left-1/4" />
        ...
        <div className="relative w-full max-w-7xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left">
            ...
            <p className={`text-lg md:text-xl text-text-secondary mb-10 max-w-xl ${isLoaded ? 'animate-fade-in-up animation-delay-200' : 'opacity-0'}`}>
            ...
            <div className={`flex flex-col sm:flex-row gap-4 justify-center lg:justify-start ${isLoaded ? 'animate-fade-in-up animation-delay-300' : 'opacity-0'}`}>
              <Link href="/crafting" className="glow-button px-8 py-4 bg-accent text-white rounded-xl font-semibold hover:scale-105 transition-all shadow-lg shadow-accent/25">
                Start Crafting!
              </Link>
              <Link href="/cooking" className="px-8 py-4 bg-gradient-to-r from-orange-500 to-red-500 text-white rounded-xl font-semibold hover:scale-105 transition-all shadow-lg shadow-orange-500/25">
                Cook Something Tasty
              </Link>
              <Link href="/register" className="px-8 py-4 bg-bg-secondary text-text-primary rounded-xl font-semibold hover:bg-bg-hover transition-all border border-border hover:border-accent shimmer-border">
                Join the Adventure
              </Link>
            </div>
          </div>
          ...
          <div className="relative hidden lg:block">
            <div className="relative rounded-2xl overflow-hidden border border-border shadow-2xl shadow-black/40">
              {/* Screenshot */}
              <img
                src="/img/screenshot/landing.jpg"
                alt="Wurm Tools preview"
                className="
                  w-full h-auto
                  object-cover
                  opacity-80
        ...
        <a
          href="#stats"
          className="absolute bottom-6 left-1/2 -translate-x-1/2 text-text-muted hover:text-accent transition-colors"
        >
      ...
      {/* Stats Bar */}
      <section
        className={`relative py-12 px-4 overflow-hidden border-y border-border ${
      ...
      >
        ...
        <div className="absolute -bottom-28 -right-28 w-72 h-72 bg-purple-500/10 rounded-full blur-3xl" />

        <div className="max-w-5xl mx-auto relative">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {[
              { value: animatedItems, label: "Items in Database" },
              { value: animatedRecipes, label: "Crafting Recipes" },
              { value: animatedMembers, label: "Community Members" },
              { value: animatedOrders, label: "Active Orders" },
            ].map((s, i) => (
              <div
                key={i}
                className="
                  group relative text-center cursor-default
                  p-5 rounded-2xl
                  bg-bg-secondary/70 backdrop-blur-sm
              ...
              >
                {/* hover glow overlay */}
                <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-accent/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none" />

                <div className="relative">
                  <div className="text-3xl md:text-4xl font-bold text-accent stat-number">
                    {s.value}
                  </div>
    ...
    {feature.imageSrc ? (
      <>
        ...
        <img
          ...
          alt={feature.imageAlt || `${feature.title} screenshot`}
          className="absolute inset-0 w-full h-full object-cover opacity-90 group-hover:opacity-100 transition-opacity duration-500"
          loading="lazy"
        />

        {/* Subtle overlay */}
        <div className="absolute inset-0 bg-gradient-to-br from-bg-primary/30 via-transparent to-bg-primary/40 pointer-events-none" />
