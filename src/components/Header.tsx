...
const navCategories: NavCategory[] = [
  {
    ...
    items: [
      ...
      { href: "/prices", label: "Price Guide", icon: "tag", description: "Item prices & values" },
      { href: "/merchants", label: "Merchants", icon: "merchant", description: "Find merchants & shops" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/archaeology", label: "Archaeology", icon: "archaeology", description: "Old deed & ruin locations" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/chat-analyzer", label: "Chat Analyzer", icon: "chat", description: "Forensic alt detection" },
